...
export default function ProductsPage() {
  return (
    <>
      <Hero
        backgroundImage="/Lays-2025-12-13/Hero/Lays_Homestyle-02.jpg"
        headline="Our Products"
        body="<p>Discover the Lay's range — from classic favorites to bold, crunchy innovations.</p>"
        buttonLabel="Browse the range"
        buttonHref="#range"
      />
      <TextSection
        headline="Browse the range"
        text="<p>Explore our chips by range below. Each product has its own unique crunch and flavor — perfect for sharing, snacking, and everything in between.</p>"
      />
      <ProductOverview
        id="range"
